...
for idthres in 50 90; do
  for alph in "bear" "qbear" "Zbear"; do
    ...
    python3 scripts/make_PSSM.py ${alph}_${idthres} outputs/MBRs/${alph}_${idthres}/MBR_${alph}_${idthres}.tsv data/alphabets/${alph}.tsv data/Rfam13.0/gapped_fam/gapped_fam_dict.pickle.gz
