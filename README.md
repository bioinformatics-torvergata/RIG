...
The next step is to crete the new BEAR alignments.
...
```
python3 scripts/compute_rscape_power.py data/Rfam14.2/stockholm/ data/Rfam14.2/Rscape ~/dir/where/rscape/is/installed/R-scape
```
